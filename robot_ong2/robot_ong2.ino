...
#define M1_PWM 5    // pwm pin motor 2
#define M1_INA 7    // control pin INA 3
#define M1_INB 8    // control pin INB 4

#define M2_PWM 6    // pwm pin motor 5
#define M2_INA 4    // control pin INA 6
#define M2_INB 9    // control pin INB 7
...
void loop() {
  ...
  turn(-200); // turn
  delay(4000); // drive while turning for 2 seconds
